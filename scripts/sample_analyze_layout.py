...
DEFAULT_ENDPOINT_ENV = "DOCUMENTINTELLIGENCE_ENDPOINT"
DEFAULT_KEY_ENV = "DOCUMENTINTELLIGENCE_API_KEY"
...
def analyze_layout_from_url():
    endpoint = os.environ.get(DEFAULT_ENDPOINT_ENV)
    key = os.environ.get(DEFAULT_KEY_ENV)

    if not endpoint or not key:
        raise RuntimeError("Missing DOCUMENTINTELLIGENCE_ENDPOINT/DOCUMENTINTELLIGENCE_API_KEY in .env")
